    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        ...
        <div class="flex flex-col flex-1">
            ...
            <a href="{{ route('dashboard') }}"
                class="flex items-center justify-start font-black p-2 text-2xl rounded-sm hover:bg-gray-600 hover:rounded-md transition duration-200 {{ request()->segment(1) == 'dashboard' ? 'bg-white text-gray-900 hover:text-white' : 'text-white' }} ">
                <x-heroicon-s-home class="w-10 h-10 mr-4 shrink-0" />
                Dashboard
            </a>

            <a href="{{ route('income.index') }}"
                class="flex items-center justify-start font-black p-2 text-2xl rounded-sm hover:bg-gray-600 hover:rounded-md transition duration-200 {{ request()->segment(1) == 'income' ? 'bg-white text-gray-900 hover:text-white' : 'text-white' }}">
            ...
            <a href="{{ route('dashboard') }}"
                class="flex items-center justify-start font-black p-2 mb-5 text-2xl rounded-sm hover:bg-gray-600 hover:rounded-md transition duration-200 {{ request()->segment(1) == 'settings' ? 'bg-white text-gray-900 hover:text-white' : 'text-white' }}">
