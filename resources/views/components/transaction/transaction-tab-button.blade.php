<div x-data="{ calculator: false }">
    <div class="bg-white  rounded-md shadow px-6 py-4 transition-all duration-300">
        ...
        <div class="flex flex-col sm:flex-row w-full justify-between transition-all duration-300">

            <div :class="calculator ? 'lg:w-3/4' : 'w-full'" class="sm:px-6 transition-all duration-300">
