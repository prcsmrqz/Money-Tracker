<ul
    class="flex w-full text-lg font-medium text-gray-600 rounded-lg border-b border-gray-200 dark:divide-gray-700 dark:text-gray-400">
    <li class="w-full focus-within:z-10">
        <a href="#" @click.prevent="activeTab = 'income'"
            :class="activeTab === 'income'
                ...
                'bg-white dark:bg-gray-800 hover:text-gray-700 hover:bg-gray-50 dark:hover:text-white dark:hover:bg-gray-700  border-r border-gray-300 dark:border-gray-600'"
